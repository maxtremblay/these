...
à la figure~\ref{fig:circuit_code_polaire} et en considérant $G_1$ comme le circuit identité
sur un seul bit.
...
Il suffit alors d'assigner de choisir 
\begin{equation}
...
ce réseau se simplifie en un réseau de tenseurs en forme d'arbre.
...
\begin{figure}
  ...
  \caption[Exemple de simplification de la contraction d'un code polaire]{
    ...
    Les transformations de la forme $(u_1, u_2) \to (v_1, v_2)$ sont données à l'équation REF.
  }
