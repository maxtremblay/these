...
Les matrices densités permettent également d'obtenir une représentation graphique d'un code.
...
entre autres puisqu’il s’agit de problèmes auxquels tous les problèmes de la classe NP
...
Cette article est le résultat de la combinaison de l'expertise que j'ai développée avec David Poulin
